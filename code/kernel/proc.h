...
struct trapframe {
  ...
  /*  96 */ uint64 s0;
  /* 104 */ uint64 s1;
  /* 112 */ uint64 a0;            // contains return value of syscall, also a0-a5 will be arguments
  /* 120 */ uint64 a1;
  /* 128 */ uint64 a2;
  /* 136 */ uint64 a3;
  /* 144 */ uint64 a4;
  /* 152 */ uint64 a5;
  /* 160 */ uint64 a6;
  /* 168 */ uint64 a7;            // contains syscall number
  /* 176 */ uint64 s2;
  /* 184 */ uint64 s3;
  /* 192 */ uint64 s4;
  /* 200 */ uint64 s5;
...
struct proc {
  ...
  int mask;                    // Mask of Syscall

  int ticks;                    // number of cpu ticks
  int elapsed_ticks;            // number of ticks since last call
  uint64 handler;               //sort of like a signal, is like the function that needs to be executed
  ...
  uint queued;                  // Tells if the process is in a queue or not
